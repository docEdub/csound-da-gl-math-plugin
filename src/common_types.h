...
typedef struct DaGLMath_Nil__Vec3
{
    OPDS h;
    ARRAYDAT *v;
} DaGLMath_Nil__Vec3;
...
typedef struct DaGLMath_Num__Vec3
{
    OPDS h;
    MYFLT *out;
    ARRAYDAT *v;
...
typedef struct DaGLMath_Num__Vec3_Vec3
{
    OPDS h;
    MYFLT *out;
    ARRAYDAT *v1;
    ARRAYDAT *v2;
} DaGLMath_Num__Vec3_Vec3;
...
typedef struct DaGLMath_Vec3__Vec3
{
    OPDS h;
    ARRAYDAT *out;
    ARRAYDAT *v;
