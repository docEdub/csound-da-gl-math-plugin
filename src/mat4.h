...
typedef DaGLMath_void__Mat4                                     DaGLMath_Mat4_transpose;
...
typedef DaGLMath_Mat4__Mat4                                     DaGLMath_Mat4_transpose_to;
int32_t da_gl_math_mat4_transpose_to_init   (CSOUND *csound,    DaGLMath_Mat4_transpose_to *p);
int32_t da_gl_math_mat4_transpose_to        (CSOUND *csound,    DaGLMath_Mat4_transpose_to *p);
